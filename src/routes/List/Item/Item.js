...
export function Item(props) {
    return (
        <li className="flex items-center py-2 px-3 bg-white hover:bg-slate-100 shadow h-[50px] rounded cursor-pointer">
            <CompletedCheckbox checked={props.completed} onChange={props.onSetItemCompleted} />
