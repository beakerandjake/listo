...
const VARIANTS = {
  danger:
    'text-white bg-red-600 enabled:hover:bg-red-700 focus-visible:ring-red-500',
  success: 'bg-green-700 text-green-100 enabled:hover:bg-green-800',
  default:
    'text-gray-700 bg-white enabled:hover:bg-gray-50 focus-visible:ring-indigo-500',
};
...
const SIZES = {
  ...
  responsive:
    'px-4 py-2 text-base sm:px-4 sm:py-2 sm:text-sm md:px-3 md:py-2 md:text-sm',
};
