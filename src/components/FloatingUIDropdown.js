...
export const MenuComponent = forwardRef(({ children, label, ...props }, ref) => {
...
export const Menu = forwardRef((props, ref) => {
    ...
    // If this is the root menu, wrap it with a tree so sub menus work.
    if (parentId == null) {
        return (
            <FloatingTree>
