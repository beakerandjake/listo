      ...
      */}
            <div>
                ...
                <div className="md:pl-64 flex flex-col flex-1">
                    <div className="sticky top-0 z-10 md:hidden pl-1 pt-1 sm:pl-3 sm:pt-3 bg-slate-200 shadow-lg shadow-black pb-2 flex justify-center items-baseline">
                        {/* <h2 className="text-sm font-medium text-gray-500">Viewing List</h2> */}
                        {/* <h1 className="text-3xl px-2 font-semibold text-gray-900">Grocery</h1> */}
                        <Logo />
                    </div>
                    <main className="flex-1">
                        <div className="sticky top-0 z-10 md:hidden pl-1 pt-1 sm:pl-3 sm:pt-3 bg-white flex justify-between items-baseline">
                            {/* <h2 className="text-sm font-medium text-gray-500">Viewing List</h2> */}
                        ...
                        <div className="py-2">
                            <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
                                {/* <h2 className="text-sm font-medium text-gray-500">Edit List</h2> */}
                                <div>
                                    <span className="text-3xl text-gray-700 hidden md:inline">Lists / </span>
                                    <span className="text-3xl font-medium text-gray-900 hidden md:inline">Grocery</span>
                                </div>
                            </div>
                            <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
