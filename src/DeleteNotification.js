            ...
            <div className="p-3">
                <div className="flex items-center">
                    <div className="w-0 flex-1 flex justify-between">
                        ...
                        <button
                            type="button"
                            className="ml-3 flex-shrink-0 bg-white text-sm font-medium text-blue-600 hover:text-blue-500 focus:outline-none"
                    ...
                    <div className="ml-4 flex-shrink-0 flex">
                        <button
                            type="button"
                            className="bg-white inline-flex text-gray-400 hover:text-gray-500 focus:outline-none"
