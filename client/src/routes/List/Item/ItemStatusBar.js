 ...
 */
const StatusField = ({ icon, text, className }) => {
  return (
 ...
 */
export const ItemStatusBar = ({ note, dueDate, completed }) => {
  ...
  return (
    <div className="flex items-center gap-2">
      ...
      {/* Status Separator */}
      <span className="last:hidden first:hidden text-gray-400 text-xs font-medium">
        {'\u2022'}
      </span>
