 ...
 */
const QuantityInput = ({ value, onValueChange }) => {
  ...
  const onInputChange = (e) => {
    ...
    onValueChange(
      Math.max(EXTERNAL_MIN_QUANTITY, Math.min(MAX_QUANTITY, value))
    );
  };
 ...
 */
const DefaultTrigger = forwardRef(({ quantity, onClear, ...props }, ref) => {
  return (
    <ItemFieldMenuButton
      {...props}
      ref={ref}
