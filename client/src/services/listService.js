const lists = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        quantity: 4,
        completed: true,
        created: new Date(2022, 5, 22).toISOString(),
      },
      {
        id: 3,
        name: 'Oranges',
        quantity: 5,
        completed: false,
        created: new Date(2022, 6, 29).toISOString(),
      },
      {
        id: 4,
        name: 'Pears',
        quantity: 2,
        completed: false,
        created: new Date(2022, 6, 3).toISOString(),
      },
      {
        id: 5,
        name: 'Bread Flour',
        quantity: 3,
        completed: false,
        created: new Date(2022, 1, 11).toISOString(),
      },
      {
        id: 6,
    ...
    items: [
      {
        ...
        quantity: 1,
        completed: false,
        created: new Date(2022, 2, 14).toISOString(),
      },
      {
        id: 2,
        name: 'Death Valley',
        quantity: 1,
        completed: false,
        created: new Date(2022, 3, 6).toISOString(),
      },
    ],
  },
  {
